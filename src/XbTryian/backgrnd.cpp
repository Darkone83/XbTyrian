...
{
	if (!(surface->format->BitsPerPixel == 8)) { OutputDebugStringA("assert failed\n"); }
...
{
	if (!(src->format->BitsPerPixel == 8 && dst->format->BitsPerPixel == 8)) { OutputDebugStringA("assert failed\n"); }
