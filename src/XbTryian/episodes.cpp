...
void JE_initEpisode(JE_byte newEpisode)
{
	...
	wsprintfA(levelFile, "tyrian%d.lvl", episodeNum);
	wsprintfA(cube_file, "cubetxt%d.dat", episodeNum);
	wsprintfA(episode_file, "levels%d.dat", episodeNum);
...
void JE_scanForEpisodes(void)
{
	...
	{
		char ep_file[20];
		wsprintfA(ep_file, "tyrian%d.lvl", i + 1);
